    ...
    : AudioProcessorEditor(&p), processor(p)
{
    ...
    levelKnob.setTextBoxStyle(Slider::TextEntryBoxPosition::TextBoxAbove, false, 3 * unit, unit);
    ...
    feedbackKnob.setTextBoxStyle(Slider::TextEntryBoxPosition::TextBoxAbove, false, 3 * unit, unit);
